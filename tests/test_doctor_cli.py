...
class DoctorCliTests(unittest.TestCase):
    ...
    def test_install_runtime_assets_apply_copies_central_assets(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((target / ".modeller/runtime/method/workflows/v-cycle.family.yaml").exists())
            self.assertTrue((target / ".modeller/runtime/method/workflows/v-cycle.stages.yaml").exists())
            self.assertTrue((target / ".modeller/runtime/method/policies/v-cycle-vigilance.yaml").exists())
            ...
            self.assertTrue((target / ".modeller/runtime/schemas/v-cycle-trace.schema.json").exists())
            self.assertTrue((target / ".modeller/runtime/schemas/human-review-receipt.schema.json").exists())
            self.assertTrue((target / ".modeller/runtime/schemas/subagent-work-order.schema.json").exists())
            self.assertTrue((target / ".modeller/runtime/schemas/subagent-lane-receipt.schema.json").exists())
